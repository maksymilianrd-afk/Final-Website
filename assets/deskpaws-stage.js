...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cr,depthTest:!1,depthWrite:!1})}function v0(){return new Bi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:np(),fragmentShader:`
		...
		`,blending:Cr,depthTest:!1,depthWrite:!1})}function y0(){return new Bi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:np(),fragmentShader:`
...
#define LOW_PRECISION`),e}function dw(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===_d?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===mh?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===ir&&(e="SHADOWMAP_TYPE_VSM"),e}function pw(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case qs:case Ys:e="ENVMAP_TYPE_CUBE";break;case Tc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function mw(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ys:e="ENVMAP_MODE_REFRACTION";break}return e}function gw(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case yd:e="ENVMAP_BLENDING_MULTIPLY";break;case G_:e="ENVMAP_BLENDING_MIX";break;case V_:e="ENVMAP_BLENDING_ADD";break}return e}function _w(r){let e=r.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function bw(r,e,t,n){let i=r.getContext(),s=t.defines,a=t.vertexShader,o=t.fragmentShader,c=dw(t),l=pw(t),h=mw(t),u=gw(t),f=_w(t),d=sw(t),g=aw(s),_=i.createProgram(),m,p,x=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Ic).join(`
`)),a=Jd(a),a=D0(a,t),a=L0(a,t),o=Jd(o),o=D0(o,t),o=L0(o,t),a=N0(a),o=N0(o),t.isRawShaderMaterial!==!0&&(x=`#version 300 es
